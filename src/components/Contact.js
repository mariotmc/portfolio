  ...
  return (
    <section id="contact">
      ...
      <div className="contact-container content-container">
        <p>
          If you have an opportunity to share, or would like to discuss anything, please contact me under the
          following below.
        </p>
        <div className="icon-container">
          <a href="mailto:mariotomicpro@gmail.com" className="contact-link">
          ...
          <a
            href="https://www.linkedin.com/in/mario-tomic-373286168/"
            target="_blank"
          ...
          <a href="https://github.com/mariotmc" target="_blank" className="contact-link">
            <svg viewBox="0 0 24 24">
